...
export interface Page {
  ...
  options?: {
     ...
     */
    display?: ('full_hero' | 'reduced_hero' | 'normal_page') | null;
    /**
     * Check to show the breadcrumb navigation at the top of this page.
     */
    showBreadcrumbs?: boolean | null;
    /**
     * Check to show the available languages widget.
     */
    showAvailableLanguages?: boolean | null;
    /**
     * Check to show the social media share widget.
     */
    showSocialShare?: boolean | null;
  };
  content: (RichTextBlock | PhotoBlock)[];
  sidebarFirst?: unknown[] | null;
  sidebarSecond?: unknown[] | null;
  slug?: string | null;
  publishedOn: string;
  editor: string | User;
